package com.phoint.facebooksimulation.ui.seenCommentAvatar
...
import com.phoint.facebooksimulation.databinding.FragmentSeenCommentAvatarBinding
...
class SeenCommentAvatarFragment :
    BaseFragment<FragmentSeenCommentAvatarBinding, SeenCommentAvatarViewModel>() {
    companion object {
    ...
    override fun layoutRes(): Int {
        return R.layout.fragment_seen_comment_avatar
    }

    override fun viewModelClass(): Class<SeenCommentAvatarViewModel> {
        return SeenCommentAvatarViewModel::class.java
    }
            ...
            viewModel.informationUserComment.observe(this) {
                if (!isLiked) {
                    ...
                    val newNotification = Notification().apply {
                        ...
                        postId = post?.idPost
                        notificationType = "${it.nameUser} thích ảnh đại diện của bạn"
    ...
    private fun handleGetDataUser() {
        ...
        viewModel.informationUser.observe(this) {
            binding.abComment.setTextUser("${it.nameUser} đã cập nhật ảnh đại diện của bạn ấy")
